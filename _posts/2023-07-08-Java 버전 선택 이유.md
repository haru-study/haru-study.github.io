...
<img src = "./img/jetbrains_java.png" style="width:60%; height:60%"/>
...
Java 11과 Java 17의 차이점에 대해 알아보았다.

하루스터디 팀은 Java 17을 선택했는데, 대표적인 요인은 다음과 같았다.
...
[https://ko.wikipedia.org/wiki/자바_버전_역사](https://ko.wikipedia.org/wiki/%EC%9E%90%EB%B0%94_%EB%B2%84%EC%A0%84_%EC%97%AD%EC%82%AC)
